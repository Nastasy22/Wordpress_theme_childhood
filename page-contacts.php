...
<div class="contacts" id="contacts">
    <h1 class="title"><?php the_field('map_title')?></h1>
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="contacts__descr underlined">
                    <?php the_field('map_descr')?>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div action="#" class="contacts__feed">
                    <?php echo do_shortcode( '[contact-form-7 id="159" title="Форма отзыва"]' ); ?>
